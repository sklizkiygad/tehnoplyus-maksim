...
export const SearchTopBar: FC<any> = ({count, title}) => {
	...
	return (
		<div className="flex justify-between items-center mb-7 text-secondary font-text">
			<Text variant="pageHeading" className="hidden lg:inline-flex pb-1 text-secondary font-subtitle">
			...
			<div className="flex items-center justify-end">
				<div className="flex-shrink-0 text-body text-xs md:text-sm leading-4 pe-4 md:me-6 ps-2 hidden lg:block text-info">
					{count} {t("text-items")}
				</div>
				<ListBox
					options={[
