	...
	({ labelKey, ...rest }, ref) => {
		...
		return (
			<label className="group flex items-center text-heading text-sm cursor-pointer">
				<input
					type="radio"
					className="form-radio w-5 h-5 border border-primary text-heading rounded-full cursor-pointer transition duration-500 ease-in-out focus:ring-offset-0 hover:border-primary focus:outline-none focus:ring-0 focus-visible:outline-none checked:bg-primary-content"
					ref={ref}
					{...rest}
				/>
