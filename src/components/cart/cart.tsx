...
export default function Cart() {
	...
	return (
		<div className="flex flex-col w-full h-full justify-between font-text text-secondary">
			<div className="w-full flex justify-between items-center relative ps-5 md:ps-7 py-0.5 border-b border-gray-100">
				<h2 className="font-bold text-xl md:text-2xl m-0 font-subtitle">
			...
			>
				<Link
					...
					className={cn(
						"bg-primary w-full px-5 py-3 md:py-4 flex items-center justify-center bg-heading rounded-md text-sm sm:text-base text-white focus:outline-none transition duration-300 hover:bg-primary-focus",
						{
