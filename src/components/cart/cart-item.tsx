...
const CartItem: React.FC<CartItemProps> = ({ item }) => {
	...
	const price = formatPrice({amount: item.price, currencyCode: item.currency, locale: 'ru'});
	const totalPrice = formatPrice({amount: item.itemTotal, currencyCode: item.currency, locale: 'ru'});
