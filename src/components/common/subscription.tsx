...
const Subscription: React.FC<Props> = ({
	...
	return (
		<div
			className={`${className}  font-text text-secondary flex flex-col xl:flex-row justify-center xl:justify-between items-center rounded-lg bg-base-200 py-10 md:py-14 lg:py-16`}
		>
			<div className="-mt-1.5 lg:-mt-2 xl:-mt-0.5 text-center xl:text-start mb-7 md:mb-8 lg:mb-9 xl:mb-0">
				<Text
					variant="mediumHeading"
					className="mb-2 md:mb-2.5 lg:mb-3 xl:mb-3.5 text-accent font-days"
				>
					{t(`${title}`)}
				</Text>
