...
const MobileMenu: FC<MobileMenuProps> = ({menu}) => {
	...
	return (
		<>
			<div className="flex flex-col justify-between w-full h-full 5 bg-base-200 text-secondary font-text ">
				...
				<Scrollbar className="menu-scrollbar flex-grow mb-auto">
					<div className="flex flex-col py-7 px-0 lg:px-2 text-heading">
						<ul className="mobileMenu">
							{menu.map((menu: any, index: string) => {
								const dept: number = 1;
				...
				<div className="flex items-center justify-center 5 bg-base-200  border-t border-gray-100 px-7 flex-shrink-0 space-s-1">
