...
const Copyright: React.FC<CopyrightProps> = ({ payment }) => {
	...
	return (
		<div className="border-t border-gray-300 pt-5 pb-16 sm:pb-20 md:pb-5 mb-2 sm:mb-0 text-info font-text">
			<Container className="flex flex-col-reverse md:flex-row text-center md:justify-between">
				<p className="text-xs lg:text-sm leading-6">
					...
					<a
						className="font-semibold text-accent transition-colors duration-200 ease-in-out hover:text-body"
