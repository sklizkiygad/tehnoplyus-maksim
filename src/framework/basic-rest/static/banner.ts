...
export const homeThreeBanner = [
  {
    ...
    image: {
      mobile: {
        url: "/assets/client/feed-1-mobile.jpg",
        width: 450,
        height: 180,
      },
      desktop: {
          url: "/assets/client/banner-feed-1.jpg",
        width: 1800,
        height: 570,
      },
    },
  },
  {
    ...
    slug: "products",
      image: {
          mobile: {
              url: "/assets/client/feed-2-mobile.jpg",
              width: 450,
              height: 180,
          },
          desktop: {
              url: "/assets/client/banner-feed-2.jpg",
              width: 1800,
              height: 570,
          },
      },
...
export const homeThreeMasonryBanner = [
  {
    ...
    image: {
      mobile: {
        url: "/assets/client/carousel.webp",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/client/carousel-1.webp",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/client/carousel-2.webp",
        width: 470,
        height: 232,
      },
      desktop: {
...
export const promotionBannerTwo = [
	...
	},
	{
		...
		image: {
			mobile: {
                url: "/assets/client/banner-2.jpg",
				width: 450,
				height: 150,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
                url: "/assets/client/banner-3.jpg",
				width: 450,
				height: 150,
			},
			desktop: {
...
export const homeSixHeroImages = [
  {
		...
		image: {
			mobile: {
				url: "/assets/client/main-mobile.png",
				width: 690,
				height: 480,
			},
			desktop: {
				url: "/assets/client/banner-big.jpg",
				width: 1800,
				height: 800,
			},
		},
